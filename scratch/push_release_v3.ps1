# E:\Anilab\scratch\push_release_v3.ps1
...
$apkPath = "E:\Anilab\android\app\build\outputs\apk\release\app-release.apk"
...
$body = @{
    ...
    "name" = $releaseName
    "body" = "AniLab Mobile v1.0.0. Restored full Capacitor WebView architecture. Features the exact responsive web interface, style guidelines, and HTML5 HLS watch player with 100% viewport optimization."
    "draft" = $false
    "prerelease" = $false
} | ConvertTo-Json
