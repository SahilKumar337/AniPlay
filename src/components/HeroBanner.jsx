  ...
  return (
    <div style={{
      ...
      <div style={{
        ...
        {/* We use the portrait cover poster as the full-bleed background to stretch all the way from left to right and match mobile screen viewports perfectly without pixelation */}
        <img
          src={cover}
          alt={title}
      ...
      {animes[nextIdx] && (
        <img
          src={animes[nextIdx].bannerImage || getCover(animes[nextIdx])}
          alt=""
